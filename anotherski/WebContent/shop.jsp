				 ...
				 <div class="header-left">
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="${ctx}/images/nav.png" alt="" /></a>
						    <ul class="nav" id="nav">
						    	<li><a href="${ctx}/product/find1">最新商品</a></li>
								<li><a href="${ctx}/product/find2">促销商品</a></li>
								<li><a href="${ctx}/product/find">全部商品</a></li>								
								<div class="clear"></div>
							</ul>
      ...
      <div class="shop_top">
		<div class="container">
			...
			<c:forEach items="${page.list}" var="p">
				<div class="col-md-3 shop_box"><a href="${ctx}/single.html">
					<img src="${ctx}/images/pic5.jpg" class="img-responsive" alt=""/>
					<span class="new-box">
						<span class="new-label">${p.type}</span>
					</span>
					<span class="sale-box">
						<span class="sale-label">京东</span>
					</span>
					<div class="shop_desc">
						<h3><a href="#">${p.productName}</a></h3>
						<p>${p.productInfo} </p>
						<span class="reducedfrom">${p.id}</span>
						<span class="actual">${p.price}</span><br>
						<ul class="buttons">
							<li class="cart"><a href="${ctx }/cart/add?productId=${p.id}">加入购物车</a></li>
							<li class="shop_btn"><a href="${ctx}/cart/checkCart">查看购物车</a></li>
							<div class="clear"> </div>
					    </ul>
				    </div>
				</a>
				...
				<a href="${ctx }/${path}?pageNum=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ctx }/${path}?pageNum=${page.getPrePageNum() }">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ctx }/${path}?pageNum=${page.getNextPageNum() }">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="${ctx }/${path}?pageNum=${page.totalPageNum }">末页</a>	  
	  		</div>	
